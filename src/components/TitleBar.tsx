...
export function TitleBar() {
  ...
  return (
    <div className="h-12 border-b border-slate-200 dark:border-slate-800 bg-white/50 dark:bg-[#0A0A0B]/50 backdrop-blur flex items-center justify-between pr-4 pl-[88px] shrink-0 shadow-sm" style={{ WebkitAppRegion: 'drag' } as any}>
